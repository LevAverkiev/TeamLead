...
$(function() {
    ...
    $('.circle-name').on('click', function() {
        $('.info-name').slideToggle();
    });

    $('.circle-phone').on('click', function() {
        $('.info-phone').slideToggle();
    });

    $('.plus').on('click', function() {
        $(this).closest('.sostav__item-wrap').toggleClass('active');
        $(this).toggleClass('rotate');
    });

    $('.recalls__items').slick({
        dots: true,
    });
